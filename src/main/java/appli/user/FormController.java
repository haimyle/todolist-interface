...
public class FormController implements Initializable {
    ...
    public FormController(User userConnecte){
        this.userConnecte = userConnecte;
    }
    public FormController(User userConnecte, User user){
        this.user = user;
        this.userConnecte = userConnecte;
        ...
        if(user == null){
            if (fldConfirmer.getText().equals(fldMotDePasse.getText())){
                ...
                try {
                    ...
                    StartApplication.changeScene("/appli/user/admin-view.fxml",new AdminController(this.userConnecte), "To-Do List - Admin");
            ...
            try {
                ...
                if(user.getIdUser() == this.userConnecte.getIdUser()){
                    StartApplication.changeScene("/appli/user/admin-view.fxml",new AdminController(this.user), "To-Do List - Admin");
